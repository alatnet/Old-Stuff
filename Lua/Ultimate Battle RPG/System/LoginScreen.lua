...
function LoginScreen()
  ...
  while not EXIT do  
    ...
    UsernameLabel:draw((((screen:width()/2)-(UsernameField:width()/2))-75),(((screen:height()/2)-(UsernameField:height()/2))-12))
    PasswordLabel:draw((((screen:width()/2)-(PasswordField:width()/2))-75),((screen:height()/2)-(PasswordField:height()/2)))
    
    --screen:print((((screen:width()/2)-(UsernameField:width()/2))-71),((screen:height()/2)-(UsernameField:height()/2))-12, "Username:", black)
    --screen:print((((screen:width()/2)-(PasswordField:width()/2))-71),((screen:height()/2)-(PasswordField:height()/2)), "Password:", black)
